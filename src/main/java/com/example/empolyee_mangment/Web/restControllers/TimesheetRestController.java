package com.example.empolyee_mangment.Web.restControllers;

import com.example.empolyee_mangment.Entites.TimeSheet;
import com.example.empolyee_mangment.Models.RestResponseEntity;
...
public class TimesheetRestController {
    ...
    public ResponseEntity getContractDocument(@RequestParam("timesheetId") long timesheetId) {
        ...
        try {
            TimeSheet.Timesheet timesheetObj = timesheetService.getTimesheetByTimesheetId(timesheetId);
            ...
            if (timesheetObj != null) {
                ...
                String mimeType = ApplicationConstant.TIMESHEET_FILE_EXTENSION_MAP.get(extn);
    ...
    public ResponseEntity<RestResponseEntity> rejectTimesheet(
        ...
        try {
            ...
            restResponseEntity = new RestResponseEntity(ApplicationConstant.REST_RESPONSE_CODE_SUCCESS,
